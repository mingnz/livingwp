...
layout: home
description: >-
  Explore the latest national AI snapshot and sector reports across Aotearoa
  New Zealand.
---
...
{% include snapshot_feature.md heading="State of AI in New Zealand" primary_label="Read the full snapshot" secondary_label="Browse industry articles" show_industry_link=true show_empty=true %}
